...
/*
 ...
 iMultiDimArray [3][4][5]:

             column 0      column 1      column 2     column 3      column 4
           ------------------------------------------------------------------
    row 0 | x[0][0][0] || x[0][1][1] || x[0][1][2] | x[0][1][3] | x[0][1][4] |                             Array[0]
          |----------- ||------------||------------|------------|------------|
          |----------- ||------------||------------|------------|------------|------------
    row 1 | x[0][1][1] || x[1][0][0] || x[1][0][1] | x[1][0][2] | x[1][0][3] | x[1][0][4] |                Array[1]
          |------------||------------||------------|------------|------------|------------|
          |------------||------------||------------|------------|------------|------------|------------
    row 2 | x[0][2][1] || x[1][1][1] || x[2][0][0] | x[2][0][1] | x[2][0][2] | x[2][0][3] | x[2][0][4] |   Array[2]
          |------------||------------||------------|------------|------------|------------|------------|
    row 3 | x[0][3][1] || x[1][2][1] || x[2][1][0] | x[2][1][1] | x[2][1][2] | x[2][1][3] | x[2][1][4] |
          |------------||------------||------------|------------|------------|------------|------------|
                       || x[1][3][1] || x[2][2][0] | x[2][2][1] | x[2][2][2] | x[2][2][3] | x[2][2][4] |
                       ||------------||------------|------------|------------|------------|------------|
