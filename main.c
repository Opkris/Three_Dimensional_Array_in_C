...
/*
 ...
 iMultiDimArray [3][4][5]:  // 3 arrays with 4 rows and 5 columns each.
  ...
  ^        -------C-------------C---ARRAY 0 :-C------------C------------C-----
  |  row 0 R x[0][0][0] || x[0][0][1] || x[0][0][2] | x[0][0][3] | x[0][0][4] |                             Array[0]
  |        |----------- ||------------||------------|------------|------------|
  |        |----------- ||------------||---------ARRAY 1 :-C----|------C-----|------C-----
  |  row 1 R x[0][1][0] |R x[1][0][0] || x[1][0][1] | x[1][0][2] | x[1][0][3] | x[1][0][4] |                Array[1]
  |        |------------||------------||------------|------------|------------|------------|
 ROWS      |------------||------------||------C-----|-----C---ARRAY 2 :-C-----|------C-----|------C-----
  |  row 2 R x[0][2][0] |R x[1][1][0] |R x[2][0][0] | x[2][0][1] | x[2][0][2] | x[2][0][3] | x[2][0][4] |   Array[2]
  |        |------------||------------||------------|------------|------------|------------|------------|
  |  row 3 R x[0][3][0] |R x[1][2][0] |R x[2][1][0] | x[2][1][1] | x[2][1][2] | x[2][1][3] | x[2][1][4] |
  |        |------------||------------||------------|------------|------------|------------|------------|
  |                     |R x[1][3][0] |R x[2][2][0] | x[2][2][1] | x[2][2][2] | x[2][2][3] | x[2][2][4] |
  |                     ||------------||------------|------------|------------|------------|------------|
  |                                   |R x[2][3][0] | x[2][3][1] | x[2][3][2] | x[2][3][3] | x[2][3][4] |
  v                                   ||------------|------------|------------|------------|------------|
